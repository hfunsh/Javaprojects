//This application will Calculate and display a Loan Amortization Table, given the Loan Amount, Annual Interest Rate and Term
...
public class AmortizationTable {
	...
	public static void main(String[] args) {
		...
		int term = numYears * 12; //Convert the loan term (years) to months
			  	
		double monthlyInterest = apr/12/100 ; //Compute the Monthly Interest Rate from the Annual rate, and convert to a decimal
		
		double monthlyPayment = (monthlyInterest * loanAmt) / (1 - (Math.pow(1 + monthlyInterest, -term))); //Compute the monthly payment using a formula
